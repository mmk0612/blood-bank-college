...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('patient_appointment_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('donor_appointment_id', models.AutoField(primary_key=True, serialize=False)),
                ('datetime_of_appointment', models.DateTimeField()),
                ('appointment_fullfilled', models.BooleanField(default=False)),
                ('clinic_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='staff.clinic')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='staff.patientappointment')),
            ],
        ),
        migrations.CreateModel(
            name='BloodFromDonor',
            fields=[
                ('blood_id', models.AutoField(primary_key=True, serialize=False)),
                ('appointment_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='staff.donorappointment')),
            ],
        ),
        migrations.CreateModel(
            name='BloodAvailable',
